    ...
    exampleData.forEach(element => {
        ...
        <div class="d-flex justify-content-between">
            <div class="d-flex align-items-center">
                ...
                <h6 style="font-family: 'Poppins', sans-serif; font-size: small;"
                    class="mt-2 ms-1 fw-bold">Client Name</h6>
            </div>
            <div class="d-flex align-items-center">
                <img src="asset/download.png" class="rounded-circle" style="width: 30px;"
                    alt="Avatar" />
                <h6 style="font-family: 'Poppins', sans-serif; font-size: small;"
                    class="mt-2 ms-1 fw-bold">Sadik Istiak</h6>
            </div>
        </div>
        <div class="d-flex text-secondary justify-content-between">
            <div class="my-2 d-flex align-items-center">
                ...
                <p class="card-text  ms-1"
                    style="font-family: 'Poppins', sans-serif; font-size: 12px;">Lorem, ipsum dolor sit
                    amet conse...</p>
            </div>
            <p style="background-color: rgb(232,238,243);"
                class="my-2 fw-bold text-secondary d-flex align-items-center p-1 rounded">
        ...
        <div class="d-flex justify-content-between align-items-center">
            <img src="asset/images1.png" class="rounded-circle" style="width: 30px;" alt="Avatar" />
            <img src="asset/images2.png" class="rounded-circle" style="width: 30px;" alt="Avatar" />
            <span class="p-1 m-0 fw-bold"
                style="background-color: rgb(232,238,243); border-radius: 50%; font-size: small; color: rgb(152, 149, 149);">12+</span>
            <div class="d-flex text-secondary fw-bold">
            ...
            <div class="d-flex text-secondary fw-bold">
                <svg onclick="attacment()" data-bs-toggle="modal" data-bs-target="#exampleModal" style="height: 20px; width: 20px;" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
